...
public class ExplodeAndEpicenterExample extends Fragment {
    ...
    private void letsExplodeIt(final View clickedView) {
        ...
        TransitionSet set = new TransitionSet()
            ...
            }).setDuration(2000).excludeTarget(clickedView, true))
            .addTransition(new Fade().setDuration(2000))
            .addListener(new Transition.TransitionListenerAdapter() {

                @Override
                public void onTransitionStart(Transition transition) {
                    Toast.makeText(getActivity(), "爆炸", Toast.LENGTH_LONG).show();
                }
